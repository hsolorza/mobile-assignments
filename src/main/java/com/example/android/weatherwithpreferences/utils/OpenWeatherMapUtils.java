package com.example.android.weatherwithpreferences.utils;
...
public class OpenWeatherMapUtils {
     ...
     */
    private final static String OWM_FORECAST_APPID = "3c777e7e93e5fab70984d9b804058c40";
    private static String TYPE;

    public static class ForecastItem implements Serializable {
        public static final String EXTRA_FORECAST_ITEM = "com.example.android.weatherwithpreferences.utils.ForecastItem.SearchResult";
    ...
    public static String buildForecastURL(String forecastLocation, String temperatureUnits) {
            ...
            if (temperatureUnits.equals("celsius")) {
